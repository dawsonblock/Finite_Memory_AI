...
class Metrics:
    ...
    def __init__(self, enabled: bool = True, window_size: int = 100):
    ...
    def observe_turn(self, stats: Any, cache_hit: bool = False) -> None:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        cache_hit_rate = self.total_cache_hits / max(
            1, self.total_cache_hits + self.total_cache_misses
        )
