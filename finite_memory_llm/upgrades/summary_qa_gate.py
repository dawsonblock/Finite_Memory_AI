...
class SummaryQAGate:
    ...
    def verify(
        ...
        hallucinated = len(hallucinated_numbers) + len(hallucinated_names) + len(hallucinated_quotes)
    ...
    def verify_with_retry(
        ...
        for attempt in range(max_retries + 1):
            ...
            if attempt < max_retries:
                print(f"⚠ Summary failed verification (attempt {attempt + 1}/{max_retries + 1}), retrying...")
                summary = retry_fn()
