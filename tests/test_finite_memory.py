...
class TestCompleteFiniteMemoryLLM:
    ...
    def test_initialization(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(
            mock_backend, max_tokens=512, memory_policy="sliding", window_size=128
        )
...
class TestMemoryPolicies:
    ...
    def test_sliding_policy(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=50, memory_policy="sliding")
    ...
    def test_importance_policy_no_model(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=50, memory_policy="importance")
    ...
    def test_rolling_summary_policy(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(
            mock_backend, max_tokens=500, memory_policy="rolling_summary", summary_interval=200
        )
...
class TestLatencyBudgeting:
    ...
    def test_latency_budget_initialization(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(
            mock_backend, max_tokens=512, memory_policy="sliding", max_policy_ms=100.0
        )
...
class TestIntegration:
    ...
    def test_multi_turn_conversation(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=256, memory_policy="sliding")
    ...
    def test_different_policies_produce_results(self, mock_backend):
        ...
        for policy in policies:
            llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=256, memory_policy=policy)
...
class TestEdgeCases:
    ...
    def test_invalid_policy_fallback(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=256, memory_policy="invalid_policy")
...
class TestLogitProbes:
    ...
    def test_logit_probes_basic(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=512, memory_policy="importance")
    ...
    def test_importance_with_logit_fallback(self, mock_backend):
        ...
        llm = CompleteFiniteMemoryLLM(mock_backend, max_tokens=100, memory_policy="importance")
...
class TestAccuracyHarness:
    ...
    def test_planted_fact_structure(self):
        ...
        try:
            ...
            fact = PlantedFact(
                position="early", turn=1, question="Test?", answer="test", context="This is a test."
            )
